...
/**
 * JwtUtils is a utility class that provides methods for generating, validating, and extracting JWT tokens.
 */
@Component
public class JwtUtils {
    ...
    /**
     * Retrieves the verification key by converting the secret string to bytes using UTF-8.
