...
/**
 * CreateUserPort is an interface that defines the contract for creating a new user. It provides a
 * method to create a user with a given username and password.
 */
